...
with open('stabilization_results_1-50.pkl', 'rb') as f:
...
if several_files:
    # with open('stabilization_results_50-100_10samples.pkl', 'rb') as f:
    #     results_10 = pickle.load(f)
    # with open('stabilization_results_50-100_20samples.pkl', 'rb') as f:
    #     results_20 = pickle.load(f)
    # with open('stabilization_results_50-100_500samples.pkl', 'rb') as f:
    #     results_500 = pickle.load(f)

    # all_samples_Ks_10 = results_10['all_samples_Ks']
    # all_samples_SA_cost_10 = results_10['all_samples_SA_cost']
    # all_samples_DR_cost_10 = results_10['all_samples_DR_cost']
    # all_samples_Ks_20 = results_20['all_samples_Ks']
    # all_samples_SA_cost_20 = results_20['all_samples_SA_cost']
    # all_samples_DR_cost_20 = results_20['all_samples_DR_cost']
    # all_samples_Ks_500 = results_500['all_samples_Ks']
    # all_samples_SA_cost_500 = results_500['all_samples_SA_cost']
    # all_samples_DR_cost_500 = results_500['all_samples_DR_cost']

    # all_Ks_10 = all_samples_Ks[0] + all_samples_Ks_10[0]
    # all_Ks_20 = all_samples_Ks[1] + all_samples_Ks_20[0]
    # all_Ks_500 = all_samples_Ks[2] + all_samples_Ks_500[0]
    # all_samples_Ks = [all_Ks_10, all_Ks_20, all_Ks_500]

    # # SA error  
    # all_SA_cost_10 = all_samples_SA_cost[0] + all_samples_SA_cost_10[0]
    # all_SA_cost_20 = all_samples_SA_cost[1] + all_samples_SA_cost_20[0]
    # all_SA_cost_500 = all_samples_SA_cost[2] + all_samples_SA_cost_500[0]
    # all_samples_SA_cost = [all_SA_cost_10, all_SA_cost_20, all_SA_cost_500]

    # # DR cost
    # all_DR_cost_10 = all_samples_DR_cost[0] + all_samples_DR_cost_10[0]
    # all_DR_cost_20 = all_samples_DR_cost[1] + all_samples_DR_cost_20[0]
    # all_DR_cost_500 = all_samples_DR_cost[2] + all_samples_DR_cost_500[0]
    # all_samples_DR_cost = [all_DR_cost_10, all_DR_cost_20, all_DR_cost_500]

    with open('stabilization_results_50_M50.pkl', 'rb') as f:
        results_50 = pickle.load(f)

    all_Ks_500 = results_50['all_samples_Ks'][0]
    all_SA_cost_500 = results_50['all_samples_SA_cost'][0]
    all_DR_cost_500 = results_50['all_samples_DR_cost'][0]
...
plt.plot(np.median(all_Ks_500_errors, axis=0), label='M=50')
# plot the 25-75% quantile
plt.fill_between(np.arange(max_iter),
...
plt.semilogy(np.median(all_Jsa_10_errors, axis=0), label='M=10')
...
plt.semilogy(np.median(all_Jsa_20_errors, axis=0), label='M=20')
...
plt.semilogy(np.median(all_Jsa_500_errors, axis=0), label='M=50')
...
plt.plot(np.median(all_Jdr_500_errors[:], axis=0), label='M=50')
# plot the 25-75% quantile
